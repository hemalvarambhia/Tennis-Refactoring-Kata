...
public class TennisGame5 implements TennisGame {
    ...
    public String getScore() {
        ...
        lookup.put(Map.entry(0, 0), String.format("%s", "Love-All"));
        lookup.put(Map.entry(1, 1), String.format("%s", "Fifteen-All"));
        lookup.put(Map.entry(2, 2), String.format("%s", "Thirty-All"));
